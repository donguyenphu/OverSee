  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6 p-6 rounded-lg border bg-white shadow'>
      ...
      <div className='grid md:grid-cols-2 gap-4'>
        ...
        <div><label className='text-sm font-medium mb-1 block'>Điểm thi tốt nghiệp THPT môn giảng dạy *</label><Input type='number' required name='professionalScore' value={data.professionalScore} onChange={handleChange} placeholder='Điểm thi tốt nghiệp THPT môn giảng dạy' min='0' max='10' step='0.1' /></div>
