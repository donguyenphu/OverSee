...
interface WritingProps {
  userEmail: string;
  onComplete: (results: WritingResults1) => void;
  content: { task1: string; task2: string; task1Image?: string };
}

export interface WritingResults1 {
  task1: string;
  task2: string;
  email: string;
}
...
const Writing1: React.FC<WritingProps> = ({ userEmail, onComplete, content }) => {
  const writingTasksData: WritingTask1[] = [
    {
      taskNumber: 1,
      title: 'Task 1: Academic Writing (Data Description)',
      timeMinutes: 20,
      image: content.task1Image || '/images/wri.jpg',
