...
const faqs = [
  {
    ...
    answer: 'OverSee hiện cung cấp các khóa học <strong className="font-bold">IELTS, SAT</strong> và các môn theo chương trình giáo dục Việt Nam như <strong className="font-bold">Toán, Văn, Anh,…</strong>\nTất cả các khóa học đều được triển khai theo hình thức <strong className="font-bold">1–1 online</strong>, giúp cá nhân hóa lộ trình học theo năng lực, mục tiêu và tốc độ riêng của từng học sinh.'
  },
  {
    question: '2. Học ở OverSee có gì khác so với học thêm hay học gia sư?',
    answer: `Tại OverSee, học sinh <strong>không được “dạy học” mà được “dạy cách tự học”</strong> để một ngày không xa sẽ không còn phải phụ thuộc vào lớp học thêm nữa.
            ...
            \nKhông chỉ vậy, <strong>Mentor còn đồng hành xây dựng lộ trình học tập cá nhân, hướng dẫn cách quản lý thời gian và cân bằng giữa học – chơi</strong>, giúp học viên thay đổi toàn diện cả <strong>thói quen học tập lẫn cuộc sống</strong>.`
  },
  {
    question: '3. Chi phí học tại OverSee thế nào?',
    answer: `OverSee có nhiều chương trình học khác nhau – từ luyện thi IELTS, SAT đến các môn học theo chương trình Việt Nam.\n
              Chi phí sẽ phụ thuộc vào <strong>lộ trình</strong> và <strong>thời lượng học cá nhân hóa</strong> của từng học viên, nên không có một mức giá cố định chung.\nPhụ huynh và học sinh có thể nhắn tin trực tiếp cho <strong><a href="https://www.facebook.com/oversee.org">fanpage OverSee</a></strong> để được tư vấn chi tiết và thiết kế lộ trình học phù hợp nhất với mục tiêu, ngân sách và thời gian của mình.`
  },
  {
    question: '4. Học sinh đang mất động lực học, OverSee có giúp được không?',
    answer: `<ul>Đây chính là nhóm học sinh mà OverSee đồng hành hiệu quả nhất.\n
  ...
  },
  {
    ...
    answer: `<ul>Bất cứ khi nào bạn sẵn sàng phát triển bản thân!</ul>
