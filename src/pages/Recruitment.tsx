      ...
      <section className="py-10 bg-background">
        <div className="container mx-auto px-2 md:px-4">
          <div className="max-w-5xl mx-auto text-center space-y-5">
            ...
            <p className="text-lg md:text-xl font-semibold text-primary">Liệu bạn có là một mảnh ghép của OverSee?</p>
            <div className="text-left space-y-4 text-sm md:text-base font-medium bg-white/50 p-6 rounded-lg border">
              <p className="text-xl"><strong className="text-xl">Đối tượng tuyển dụng:</strong> Học sinh cấp 3, sinh viên đại học, người trẻ đã tốt nghiệp.</p>
              ...
              <p><strong className="text-xl">Hoàn thành đơn dưới đây, lựa chọn chuyên môn bạn mong muốn:</strong></p>
            </div>
          </div>
        </div>
      </section>
