            ...
            <div className="max-w-6xl mx-auto px-4">
              ...
              {(() => {
                const shares: { id: number; img: string; text: string; tag: string; delay: number }[] = [
                  { id: 1, img: s8, tag: '#NewShare', delay: 1.00, text: `Đúng là OverSee!` },
                  { id: 2, img: s9, tag: '#BornToSpeak', delay: 0.95, text: `Học viên bức tốc nâng band Speaking từ 5.0 lên 6.5 trong 6 tuần` },
                  { id: 3, img: s10, tag: '#WritingOnFire', delay: 0.90, text: `Học viên nâng band Writing từ 6.0 lên 7.0 trong 6 tuần` },
                  { id: 9, img: s2, tag: '#IELTSJourney', delay: 0.6, text: `Học IELTS bao nhiêu lâu rồi nhưng lần đầu tiên em chịu ngồi học từ vựng đấy ạ!` },
                  { id: 10, img: s3, tag: '#FeedbackMatters', delay: 0.55, text: `Hồi chưa gặp anh mentor em phải thuê chấm bài bên ngoài, hình như 50k/1 bài ấy. Mà giờ học OverSee mentor chấm cho em mỗi tuần 6 bài, đã thế còn chữa kỹ xong nhắc em viết lại cho hiểu bài mới thôi.` },
                  { id: 4, img: s7, tag: '#OwnYourTime', delay: 0.85, text: `Lịch học ngày trước của em đây. Sau khi học xong khóa Toán cùng mentor, em quyết định bỏ hết các chỗ học thêm để quay lại tự học. Ban đầu em cũng phải nói chuyện với bố mẹ nhiều về điều này lắm, bạn bè xung quanh cũng bảo em không học thêm sao mà giỏi được. Nhưng em tự tin em đã biết cách tự sắp xếp thời gian của mình và cũng tự biết cách tự học các môn khác, cũng giống như cách tự học Toán mà chị mentor đã hướng dẫn em. Giờ em thật sự cảm thấy làm chủ được cuộc sống của mình, biết đánh giá xem học ở đâu, thế nào mới thực sự hiệu quả. Em cảm ơn chị mentor và OverSee nhiều lắm. Hi vọng các bạn đang mất phương hướng, quá tải học thêm giống em ngày xưa cũng sẽ tìm được giải pháp và đam mê thật sự với việc học.` },
                  ...
                  { id: 6, img: s6, tag: '#TransparentProgress', delay: 0.75, text: `Tháng nào mẹ em cũng nhận được báo cáo này từ OverSee. Thế là mẹ không bao giờ phải hỏi em xem dạo này học hành thế nào nữa :))` },
                  { id: 7, img: s4, tag: '#SpeakDaily', delay: 0.7, text: `Lại đến lịch học cùng mentor của em rồi. Em sẽ tâm sự đủ chuyện trên trời dưới biển nhưng mà… bằng Tiếng Anh.` },
                  { id: 8, img: s1, tag: '#OverSeeCare', delay: 0.65, text: `Chị mentor khác hẳn những người lớn trước giờ em từng gặp. Chị không hỏi em điểm bao nhiêu, không bắt em phải học thêm gì. Chị chỉ hỏi “Em có thấy mệt không?”, “Dạo gần đây em đang áp lực phải không?”. Lần đầu tiên có người hỏi em câu đó.` },
                ];
                return (
